...
// Sostituisci l'intero contenuto del tuo file con questa versione estesa.

// 1. Classificazione di ogni blocco in categorie funzionali
const blockCategories = {
    // --- Accesso / Identificazione ---
    'Scansione rete locale': 'access',
    'Esegui port scan avanzato': 'access',
    'Trova vulnerabilità software (scanner)': 'access',
    'Intercetta chiamate API': 'access',
    'Prendi Info da Archivio': 'access',
    'Scansiona reti Wi-Fi vicine': 'access',
    'Identifica vulnerabilità XSS (base)': 'access',
    'Analizza endpoint API': 'access',
...
// 2. Definizione degli Obiettivi e delle loro regole (Percorsi Funzionali Essenziali - PFE)
const flowObjectives = {
    ...
    'dataExfiltration': {
        ...
        pfe: {
            access: { required: true, weight: 0.3, hint: "Manca un blocco per l'accesso o l'identificazione del target (es. Scansione Rete)." },
    ...
    'ransomware': {
        ...
        pfe: {
            ...
            // 'ransom_note': { required: true, weight: 0.1, hint: "Manca un blocco per comunicare la richiesta di riscatto." } // Da aggiungere quando il blocco esisterà
        }
    },
    'worm': {
