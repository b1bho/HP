...
/**
 * Funzione completa e corretta per risolvere un attacco.
 * Calcola il successo, le ricompense e il valore dei dati in USD.
 */
function resolveAttack(attack, progressPercentage) {
    ...
    // Calcola il valore dei dati in USD
    ...
    const dataPacket = {
        ...
        quantity: quantity,
        value: valueUSD // Il valore è ora in USD
    };
